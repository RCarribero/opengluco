...
## Corpus Check
- 143 files · ~95,427 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1141 nodes · 2036 edges · 115 communities (85 shown, 30 thin omitted)
...
4. `GlucoseUnit` - 42 edges
5. `GlucoseAlarm` - 42 edges
...
Cohesion: 0.12
Nodes (15): GlucoseMonitorForegroundService, Context, IBinder, Intent, Service, ConfigurationDiagnosticsDialog(), DiagnosticItemCard(), Context (+7 more)

### Community 8 - "MobileDashboardScreen.kt"
Cohesion: 0.25
Nodes (15): androidx, DailyStatItem(), DashboardChartCard(), DashboardStatsCard(), formatChartTime(), Color, com, Modifier (+7 more)
...
Cohesion: 0.25
Nodes (11): Modifier, MobileDualFloatingOrbs(), TargetRangeDialog(), DashboardHeroSection(), ClinicalColorScheme, ClinicalTheme, getClinicalStatusColor(), getGlucoseStatusColor() (+3 more)
...
### Community 91 - "MobileDashboardScreen"
Cohesion: 0.47
Nodes (5): Modifier, PatientHeaderChip(), PatientSelectorModal(), DashboardSensorCard(), MobileDashboardScreen()

### Community 92 - "WearSettingsScreen"
Cohesion: 0.80
Nodes (5): CompactActionRow(), CompactSettingsRow(), Color, Modifier, WearSettingsScreen()

### Community 93 - "PatientListCarScreen.kt"
Cohesion: 0.60
...
## Knowledge Gaps
- **235 isolated node(s):** `H24`, `H12`, `H6`, `H2`, `H1` (+230 more)
...
- **Why does `GlucoseMeasurement` connect `GlucoseMeasurement` to `E2ETier2BoundaryCornerCasesTest.kt`, `UserPreferencesRepository`, `WearDashboardScreen`, `ClinicalReportsCalculator.kt`, `GlucoseMonitorForegroundService`, `MobileDashboardScreen.kt`, `WearBluetoothRfcommService`, `ClinicalTheme`, `E2ETier1FeatureCoverageTest`, `SensorInfo`, `EmpiricalStressChallengeTest`, `WearDashboardViewModel`, `.renderSparkline`, `QrAuthHelper`, `EmpiricalStressChallengeTest.kt`, `ClinicalReportsCalculatorTest`, `HealthDataExporter`, `HealthDataExporterTest`, `CgmCurveSmootherTest`, `WearSparklineChart.kt`, `ModelSanityTest`, `DataCoherenceAndThemeTest`, `ConnectionItem`, `ReportsHubScreen.kt`, `OpenGlucoRepository.kt`?**
  _High betweenness centrality (0.204) - this node is a cross-community bridge._
- **Why does `UserPreferencesRepository` connect `UserPreferencesRepository` to `GlucoseCarSession.kt`, `GlucoseMonitorForegroundService`, `MobileDashboardScreen.kt`, `MobileAlarmNotificationHelper`, `WearBluetoothRfcommService`, `WearDashboardViewModel`, `GlucoseTileService.kt`, `WearQrLoginScreen.kt`, `wear/MainActivity.kt`, `UserSettings`, `WearLoginViewModel`, `GlucoseComplicationService.kt`, `ConnectionItem`, `BootReceiver.kt`, `MobileDashboardScreen`, `WearSettingsScreen`, `MobileWearableMessageListenerService.kt`, `WearAuthMessageListenerService.kt`, `WearGlucoseSyncWorker.kt`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `OpenGlucoRepository` connect `OpenGlucoRepository` to `WearGlucoseSyncWorker.kt`, `OpenGlucoInterceptor`, `GlucoseMonitorForegroundService`, `MobileDashboardScreen.kt`, `MobileAlarmNotificationHelper`, `wear/MainActivity.kt`, `UserSettings`, `OpenGlucoRepository.kt`, `WearLoginViewModel`, `WearDashboardViewModel`, `.login`, `ConnectionItem`, `MobileDashboardScreen`?**
